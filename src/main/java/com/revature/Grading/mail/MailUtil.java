package com.revature.Grading.mail;
...
public class MailUtil {
    public static void sendMailUsingTLS(String host,
      ...
      public static void main(String[] args) {
         ...
         String username = "subametha21@gmail.com";
         String password = "kytvmyjoxzltnczg"; 
         String fromAddress = "subametha21@gmail.com";
         String toAddress = "keyneloui@gmail.com";
